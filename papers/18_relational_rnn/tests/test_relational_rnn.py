...
def test_relational_rnn_backends_match_numpy() -> None:
...
def test_relational_rnn_one_step_improves_loss() -> None:
    config = RelationalRNNConfig()
    params = init_params(config)
    inputs, targets = build_dataset(config)
...
def test_relational_rnn_one_step_losses_match_across_backends() -> None:
    config = RelationalRNNConfig()
    params = init_params(config)
    inputs, targets = build_dataset(config)
...
def test_relational_rnn_torch_and_jax_gradients_and_updated_params_match() -> None:
    config = RelationalRNNConfig()
    params = init_params(config)
    inputs, targets = build_dataset(config)
