"""PyTorch implementation wrapper for paper 10."""
...
from s30bn.paper10_resnet import ResNetConfig, forward_torch, init_params, params_to_torch, synthetic_residual_dataset
