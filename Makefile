...
.PHONY: test run-02 run-03 run-04 run-07 run-09 run-10 run-11 run-12 run-14 run-15 run-16 run-17 run-18 run-20 run-21 run-26 agda-check agda-check-02 agda-check-03 agda-check-04 agda-check-07 agda-check-09 agda-check-10 agda-check-11 agda-check-12 agda-check-14 agda-check-15 agda-check-16 agda-check-17 agda-check-18 agda-check-20 agda-check-21 agda-check-26

test:
	$(PYTHON) -m pytest papers/02_char_rnn_karpathy/tests/test_char_rnn.py papers/03_lstm_understanding/tests/test_lstm.py papers/04_rnn_regularization/tests/test_rnn_regularization.py papers/07_alexnet_cnn/tests/test_alexnet.py papers/09_gpipe/tests/test_gpipe.py papers/10_resnet_deep_residual/tests/test_resnet.py papers/11_dilated_convolutions/tests/test_dilated_convolutions.py papers/12_graph_neural_networks/tests/test_gnn.py papers/14_bahdanau_attention/tests/test_bahdanau_attention.py papers/15_identity_mappings_resnet/tests/test_identity_mappings.py papers/16_relational_reasoning/tests/test_relational_reasoning.py papers/17_variational_autoencoder/tests/test_vae.py papers/18_relational_rnn/tests/test_relational_rnn.py papers/20_neural_turing_machine/tests/test_ntm.py papers/21_ctc_speech/tests/test_ctc.py papers/26_cs231n_cnn_fundamentals/tests/test_cnn.py -q
...
agda-check: agda-check-02 agda-check-03 agda-check-04 agda-check-07 agda-check-09 agda-check-10 agda-check-11 agda-check-12 agda-check-14 agda-check-15 agda-check-16 agda-check-17 agda-check-18 agda-check-20 agda-check-21 agda-check-26
